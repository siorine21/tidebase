...
const PATHS = {
  ...
  /* ルアーレシピ（D-080）。以前は "fish" と同じ絵だったが、
     レシピはルアーの中身（色・重さ・フック）であって魚ではない。
     ナビでは隣の「釣果」と意味がぶつかっていた。
     ルアーの形そのものは 19px では潰れて読めなかったので（ミノーはトースター、
     フックは錨に見える）、レシピの要である**色**を表すパレットにした。 */
  "recipes": '<path d="M12 22a1 1 0 0 1 0-20 10 9 0 0 1 10 9 5 5 0 0 1-5 5h-2.25a1.75 1.75 0 0 0-1.4 2.8l.3.4a1.75 1.75 0 0 1-1.4 2.8z" /> <circle cx="13.5" cy="6.5" r=".5" fill="currentColor" /> <circle cx="17.5" cy="10.5" r=".5" fill="currentColor" /> <circle cx="6.5" cy="12.5" r=".5" fill="currentColor" /> <circle cx="8.5" cy="7.5" r=".5" fill="currentColor" />',
